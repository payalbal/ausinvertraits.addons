...
##################################################
####                                          ####
#### 2. load taxonomic resources (taxon list) ####
####                                          ####
##################################################
...
##################################################
####                                          ####
#### 3. create taxon list for checking        ####
####                                          ####
##################################################

# need to have a copy of the database handy to generate list of names for matching... or this can be any taxon list, just change the name in the next code chunk too
# ausinvertraits <- remake::make("ausinvertraits")
...
##################################################
####                                          ####
#### 4. match taxa using function below       ####
####                                          ####
##################################################
...
####################################################
####                                            ####
#### 5. the actual function for aligning names  ####
####                                            ####
####################################################
