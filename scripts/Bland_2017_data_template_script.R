...
b1 <- read.csv("Bland_2017/Allometry_06062014.csv", header = T) 
b2 <- read.csv("Bland_2017/Life_History_Traits_06062014.csv", header = T) 
b3 <- read.csv("Bland_2017/Crayfish_Species_Dataset.csv", header = T) 

## Load the file containing Australian crayfish genera and family name
b_names <- read.csv("Bland_2017/aus_crayfish_genera.csv", header = T) 

## Load the data template
template <- read.csv("Bland_2017/data_template.csv", header = T) 
...
write.csv(bland_template, "Bland_2017/data.csv", row.names = FALSE) # export the data as a csv
